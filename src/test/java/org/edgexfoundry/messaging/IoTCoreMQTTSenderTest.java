...
public class IoTCoreMQTTSenderTest {
  ...
  @Before
  public void setup() {
    Addressable addressable = new Addressable(TEST_ADDR_NAME, TEST_PROTOCOL, TEST_ADDRESS,
        TEST_PORT, TEST_PUBLISHER, TEST_USER, TEST_PASSWORD, TEST_TOPIC);
  ...
  public void testSendMessage() {
    // connection information not setup to call IoT Core. It will exercise process, but not get
    // through.
