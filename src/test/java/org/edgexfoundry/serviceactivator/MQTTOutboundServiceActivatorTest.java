...
import org.edgexfoundry.serviceactivator.MQTTOutboundServiceActivator;
...
public class MQTTOutboundServiceActivatorTest {

	private MQTTOutboundServiceActivator activator;
	...
	@Before
	public void setup() {
		activator = new MQTTOutboundServiceActivator();
