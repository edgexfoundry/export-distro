...
public class IotCoreMQTTSender implements MqttCallback {
	...
	private final static org.edgexfoundry.support.logging.client.EdgeXLogger logger = org.edgexfoundry.support.logging.client.EdgeXLoggerFactory.getEdgeXLogger(IotCoreMQTTSender.class);
	...
	public IotCoreMQTTSender(Addressable addressable, String privateKeyFile, String algorithm, int qos, int keepAlive) throws Exception {
	...
	private PrivateKey loadKeyFile(String filename, String algorithm) throws Exception {
		filename = this.getClass().getClassLoader().getResource("").toString().replace("file:", "") + filename;
	...
	private String createJwt(String projectId, String privateKeyFile, String algorithm) throws Exception {
